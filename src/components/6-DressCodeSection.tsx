      ...
      <SectionContainer className="md:grid-cols-2">
        <div className="flex flex-col gap-6">
          ...
          <ul className="list-disc ml-6 mb-6">
            <li>Платья в спокойных, пастельных или светлых оттенках.</li>
            <li>
              Лаконичные фасоны, возможны разрезы, открытые плечи или спина.
            </li>
            <li>
              Минималистичные аксессуары и обувь на каблуке или без, но
              дополнительно возьмите с собой обувь на плоском ходу
            </li>
