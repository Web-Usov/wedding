...
export default function HeroSection({ bgImageUrl, weddingData }: Props) {
  ...
  return (
    ...
    >
      <div className="relative h-fit w-full  shadow inset-shadow-sm  p-22 bg-(--secondary)/20 bg-cover bg-center bg-no-repeat backdrop-blur-[1px] ">
        <div className="relative    h-full ml-auto mr-auto w-fit  z-20 flex flex-col justify-center items-center gap-6  ">
          <h1 className="text-7xl font-body    text-(--accent) font-bold  w-min md:w-auto  ">
            Alex & Mary
          </h1>
          <p className="text-3xl font-heading   ">{date}</p>
        </div>
        <img
          src="/mary.png"
